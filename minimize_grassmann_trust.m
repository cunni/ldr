...
function [ Q , fQ , info ] = minimize_grassmann_trust( f , Q , length , varargin )
    ...
    fprintf('(Grassmann manifold trust region opt completed on %s in %d iterations, objective optimized from %g to %g)\n',f,info(end).iter, fQ_0, fQ);
    %
end    