...
function [ Q , fQ , info ] = minimize_stiefel_mosd( f , Q , length , varargin )
    ...
    fprintf('(Stiefel manifold manopt steepest descent opt completed on %s in %d iterations, objective optimized from %g to %g)\n',f,info(end).iter, fQ_0, fQ);
    %
end    