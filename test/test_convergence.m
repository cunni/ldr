...
% test_convergence.m
%
% tests the convergence of several optimization methods.
% IMPORTANT NOTE:
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [] = test_convergence( run_meth , show_fig , save_fig , num_runs )
    ...
    if show_fig
        ...
        wt = 0;
        z = 255;
        colR = [255 67 92 255]/305; 
        colG = [80 255 67 174]/305;
        colB = [67 120 255 67]/305;
        col = [colR; colG; colB];
        ...
        set(gca,'ytick',10.^([-10:4:4]) );
        set(gca,'ylim',[1e-11 1e4]);
        set(gca,'xtick',[0 : .25 : 1.0 ]);
        set(gca,'xlim',[0 1.1]);
        legend( gca , 'Stiefel SD' , 'Stiefel TR' , 'Grassmann SD' , 'Grassmann TR' );
        if save_fig
            print(gcf , '-depsc', sprintf('results/test_convergence_time.eps'))
        end
        ...
        if save_fig
            print(gcf , '-depsc', sprintf('results/test_convergence_iter.eps'))
        end
